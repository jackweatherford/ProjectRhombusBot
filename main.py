...
if __name__ == '__main__':
    ...
    try: # Exits cleanly if the user ever enters Control-C.
        ...
        print('The hack is now running, please switch to Project Rhombus and play\
              in fullscreen mode on any difficulty.')
        print('If Project Rhombus starts dropping in framerate(lagging) before\
              playing, simply Alt-Tab out and back in to fix it.')
        print('When you close the game, please also terminate this process by\
              entering Control-C in the console.')
